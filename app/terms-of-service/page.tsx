          ...
          <div className="mt-10 space-y-8 text-sm leading-relaxed text-[#D0D0D0]">
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                Work may require partial or full payment before execution.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3">
                To the maximum extent permitted by applicable law, fierfek.nexus
                is not responsible for indirect losses, third-party failures,
                blockchain network issues, client misuse, loss of credentials,
                or damages caused by inaccurate instructions.
              </p>
            </section>
